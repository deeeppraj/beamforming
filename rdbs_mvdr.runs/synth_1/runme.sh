...
HD_PWD='C:/Users/Deepraj/Desktop/rdbs_mvdr/rdbs_mvdr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mvdrr_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mvdrr_wrapper.tcl
