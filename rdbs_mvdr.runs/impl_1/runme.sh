...
HD_PWD='C:/Users/Deepraj/Desktop/rdbs_mvdr/rdbs_mvdr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mvdrr_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mvdrr_wrapper.tcl -notrace
