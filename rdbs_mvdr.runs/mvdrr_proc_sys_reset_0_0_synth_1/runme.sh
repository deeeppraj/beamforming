...
HD_PWD='C:/Users/Deepraj/Desktop/rdbs_mvdr/rdbs_mvdr.runs/mvdrr_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mvdrr_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mvdrr_proc_sys_reset_0_0.tcl
