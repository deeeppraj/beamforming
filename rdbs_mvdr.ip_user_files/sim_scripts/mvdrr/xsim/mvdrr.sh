...
#
# Script generated by Vivado on Sat Jun 27 23:21:48 +0530 2026
...
#
# Usage        : mvdrr.sh
#                mvdrr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mvdrr.sh [-rerun]
#                mvdrr.sh [-reset_run]
#                mvdrr.sh [-clean]
#                mvdrr.sh [-reset_log]
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L cpm5_v1_0_20 -L cpm4_v1_0_20 -L noc_hbm_nmu_sim_v1_0_0 -L noc_nmu_sim_v1_0_0 -L versal_cips_ps_vip_v1_0_14 -L xilinx_vip"
...
# script info
echo -e "mvdrr.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mvdrr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L axi_apb_bridge_v3_0_21 -L versal_cips_ps_vip_v1_0_14 -L cpm4_v1_0_20 -L cpm5_v1_0_20 -L noc_nmu_sim_v1_0_0 -L noc_hbm_nmu_sim_v1_0_0 -L xlconstant_v1_1_10 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_37 -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_24 -L floating_point_v7_1_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mvdrr xil_defaultlib.mvdrr xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mvdrr -key {Behavioral:sim_1:Functional:mvdrr} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_342f.protoinst" -protoinst "protoinst_files/bd_48f7.protoinst" -protoinst "protoinst_files/bd_0f28.protoinst" -protoinst "protoinst_files/bd_cf79.protoinst" -protoinst "protoinst_files/mvdrr.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mvdrr.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mvdrr.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mvdrr.sh [-help]\n\
Usage: mvdrr.sh [-step]\n\
Usage: mvdrr.sh [-lib_map_path]\n\
Usage: mvdrr.sh [-rerun]\n\
Usage: mvdrr.sh [-reset_run]\n\
Usage: mvdrr.sh [-clean]\n\
Usage: mvdrr.sh [-reset_log]\n\
Usage: mvdrr.sh [-keep_index]\n\
Usage: mvdrr.sh [-noclean_files]\n\n\
