...
//
//**********************************************************************
#ifndef bd_48f7_MC0_ddrc_0_core_h_
#define bd_48f7_MC0_ddrc_0_core_h_

#include "NOCDdrMcXtlm.h"
#include "properties.h"

class bd_48f7_MC0_ddrc_0_core : public NOCDdrMcXtlm
{
public:
  bd_48f7_MC0_ddrc_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  : NOCDdrMcXtlm(nm, props)
  {
  }

  virtual ~bd_48f7_MC0_ddrc_0_core()
  {
  }
