...
(* HW_HANDOFF = "bd_342f_pspmc_0_0.hwdef" *)   
(* DONT_TOUCH = "TRUE" *)
(* DowngradeIPIdentifiedWarnings="yes" *)
module pspmc_v1_4_7_pspmc #(
  ...
  parameter C_PMC_USE_PL_ERR0 = 0,
  parameter C_PMC_USE_PL_ERR1 = 0,
  parameter C_PMC_USE_PL_ERR2 = 0,
  parameter C_PMC_USE_PL_ERR3 = 0,
  parameter C_PS_PMU_PERIPHERAL_ENABLE = 0
...
output perst0n,
output perst1n,
input pl_error_pmc_0,
input pl_error_pmc_1,
input pl_error_pmc_2,
input pl_error_pmc_3


  );

  wire [3:0] s_pmu_error_from_pl;
  wire [7:0] s_pmc_error_from_pl;

  assign s_pmc_error_from_pl[7:4] = {pl_error_pmc_3,pl_error_pmc_2,pl_error_pmc_1,pl_error_pmc_0};
  assign s_pmu_error_from_pl = pmu_error_from_pl;
...
//CPM-XPIPE wires
  ...
  wire [25:0] fmio_fpd_lpd_emio_in;
...
/////////////////////// PMC map below
  ...
  generate
   ...
   begin  
   assign pl_pcie0_resetn = fmio_fpd_lpd_emio_in[18];
   end
  ...
  generate
   ...
   begin 
   assign pl_pcie1_resetn = fmio_fpd_lpd_emio_in[19];
   end
  ...
  assign pl_ps_irq1_i = {
    ...
    //.DPVIDEOREFCLK(dp_video_ref_clk),
      ...
      .FMIOFPDLPDEMIOIN (fmio_fpd_lpd_emio_in),
      .EMIOSPI0MO(spi0_m_o),
...
//      .FTMGPI(ftm_gpi),
    ...
    //.PLFPGASTOP(pl_fpga_stop),
      ...
      .PMUERRORFROMPL(s_pmu_error_from_pl),
      .PMCPLIRQ(s_pmc_error_from_pl),
